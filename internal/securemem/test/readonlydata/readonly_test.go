...
import (
	...
	main "github.com/openkcm/krypton/internal/securemem/test/readonlydata"
)
...
func TestReadOnlyData(t *testing.T) {
	...
	// The output should contain the secret value and an error message about
	// the unexpected fault address,
